      ...
      <div className='px-8 py-16 relative'>
        <div className='max-w-7xl mx-auto relative z-10'>
          <div className='bg-white/5 border border-white/10 rounded-3xl p-12 shadow-2xl relative overflow-hidden'>
            <div className='hidden md:block absolute right-4 top-1/2 scale-x-[-1] -translate-y-1/2 text-[14rem] drop-shadow-[0_0_15px_rgba(83,101,154,0.3)]'>
              📑
            </div>
            <div className='relative z-10'>
              <div className='inline-flex items-center gap-2 bg-[#53659a]/30 border border-[#53659a]/50 rounded-full px-4 py-2 mb-6 shadow-lg shadow-[#53659a]/20'>
                ...
                <span className='text-[#53659a] font-bold uppercase tracking-wider text-sm'>
                  {trainerName || 'Trainer'}
                </span>
              </div>
            ...
            <div className='grid grid-cols-1 gap-4'>
              ...
              >
                <div className='flex items-center gap-4'>
                  ...
                  <div>
                    <h3 className='text-xl font-bold text-white group-hover:text-[#53659a] transition-colors'>
                      Manage Clients
                    </h3>
                    <p className='text-gray-300 text-sm'>
                      See all clients and add new clients
                    </p>
                  </div>
                </div>
              </button>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              >
                <div className='flex items-center gap-4'>
                  ...
                  <div>
                    <h3 className='text-xl font-bold text-white group-hover:text-[#6b9b4c] transition-colors'>
                      Create Program
                    </h3>
                    <p className='text-gray-300 text-sm'>
                      Make new programs for clients.
                    </p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className='flex items-center gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      Make new excersise to workouts.
                    </p>
                  </div>
                </div>
              </button>
